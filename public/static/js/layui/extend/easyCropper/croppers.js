...
layui.config({
    base: layui_base_url+'easyCropper/cropper/' //layui自定义layui组件目录
}).define(['jquery', 'layer', 'cropper'], function (exports) {
    var $ = layui.jquery
        , layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href='"+layui_base_url+"easyCropper/cropper/cropper.css' >\n" +
        ...
        "                    <button type=\"button\" class=\"layui-btn layui-bg-red\" cropper-event=\"confirmSave\" type=\"button\" style=\"font-size:12px !important;\"> 确定</button>\n" +
        "                </div>\n" +
        //"            </div>\n" +
        //"        </div>\n" +
