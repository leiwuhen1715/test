...
(function () {
    ...
    window.UEDITOR_CONFIG = {
		...
		,whiteList: {
			...
			article: [],
			aside:  [],
			audio:  ['autoplay', 'controls','controlslist', 'loop', 'preload', 'src', 'class', 'style'],
			b:      ['class', 'style', 'id'],
			bdi:    ['dir'],
			bdo:    ['dir'],
			big:    [],
			...
			u:      [],
			ul:     ['class', 'style', 'id'],
			video:  ['autoplay', 'controls', 'controlslist','loop', 'preload', 'src', 'height', 'width', 'class', 'style', 'id', 'poster']
		}
    };
